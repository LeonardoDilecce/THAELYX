...
function reloadAcceleration(engine,starship,deltaTime,TargetMass,targetRadius,targetAtmosphere,targetA,targetE,TargetCenter,TargetEpochAnomaly,BaseMass){
    ...
    reloadGravity(engine,globalGameData.Star,globalGameData.chronometer,starship,TargetMass,dx,dy,distanza2,distanza,targetA,targetE,TargetCenter,TargetEpochAnomaly,BaseMass,deltaTime);
